---
title: Modelovanie zmeny klímy
autor: Yuliya Chsherbakova
format: revealjs
...
Tento model kombinuje prvky autoregresie, kde teplota v čase $t$ závisí od teploty v predchádzajúcom čase $t-1$, a pohyblivého priemeru, ktorý zohľadňuje vplyv predchádzajúcich chýb na aktuálnu hodnotu teploty. Zahrnutie exogénnych premenných, ako sú emisie CO2, umožňuje lepšie porozumieť a predikovať dynamiku teploty v závislosti od zmien v týchto premenných. @noauthor_forecasting:_nodate
...
![results](ProjectForR/results.png){#fig-results width=50%}
